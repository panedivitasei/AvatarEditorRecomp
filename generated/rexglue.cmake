...
if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/generated/ae/sources.cmake")
    include(generated/ae/sources.cmake)
    set(REXGLUE_ENTRYPOINT_GENERATED_SOURCES ${GENERATED_SOURCES})
    set(REXGLUE_ENTRYPOINT_INCLUDE_DIR "${CMAKE_CURRENT_SOURCE_DIR}/generated/ae")
...
macro(rexglue_setup_target target_name)
    if(REXGLUE_ENTRYPOINT_GENERATED_SOURCES)
        ...
        rexglue_apply_recomp_settings(${target_name}_recomp
            "${REXGLUE_ENTRYPOINT_INCLUDE_DIR}/ae_pch.h")
        add_dependencies(${target_name}_recomp ae_codegen)
        target_link_libraries(${target_name} PRIVATE
            ${target_name}_recomp)
    endif()
    # Also on the host, so a tree that has never run codegen still generates it.
    add_dependencies(${target_name} ae_codegen)
...
# changes. Build it alone with 'cmake --build . --target ae_codegen'.
...
# names it.
add_custom_command(
    OUTPUT "${CMAKE_CURRENT_SOURCE_DIR}/generated/ae/codegen.build.stamp"
           ${REXGLUE_ENTRYPOINT_GENERATED_SOURCES}
    COMMAND $<TARGET_FILE:rex::rexglue> codegen ${CMAKE_CURRENT_SOURCE_DIR}/ae_manifest.toml
    DEPFILE "${CMAKE_CURRENT_SOURCE_DIR}/generated/ae/codegen.d"
    WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
    COMMENT "Generating recompiled code for ae"
    VERBATIM
)
add_custom_target(ae_codegen
    DEPENDS "${CMAKE_CURRENT_SOURCE_DIR}/generated/ae/codegen.build.stamp")

# Include DLL module shared library targets if codegen has generated them
if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/generated/ae/dll_targets.cmake")
    include(generated/ae/dll_targets.cmake)
endif()
